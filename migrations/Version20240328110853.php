 ...
 */
final class Version20240328110853 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT AUTO_INCREMENT NOT NULL, language_id INT NOT NULL, title VARCHAR(255) NOT NULL, transcription LONGTEXT NOT NULL, src VARCHAR(255) NOT NULL, INDEX IDX_F87474F382F1BAF4 (language_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
